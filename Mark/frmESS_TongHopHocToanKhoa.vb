...
#End Region
    ...
    Private Sub btnPrint1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint1.Click
        Try
            ...
            Dim dtMonHoc As DataTable
            Dim dtMonTN As New DataTable
            Dim dsXepHangTotNghiep As New XepHangTotNghiep
            ...
            dtMonHoc = clsDiem.DanhSachMonHoc
            dtMonTN = clsDiem.DanhSachMonTotNghiep_LTN_THN
            Dim dt As DataTable = fgTongHopToanKhoa.DataSource
            Dim dtDiemTH As DataTable
            dtDiemTH = dt.Copy
            Dim ID_mon_LT As Integer = 0
            Dim ID_mon_TH As Integer = 0
            If dtMonTN.Rows.Count > 0 Then
                ID_mon_LT = dtMonTN.Rows(0)("ID_mon")
                ID_mon_TH = dtMonTN.Rows(1)("ID_mon")
                dtDiemTH.Columns.Add("TBC_TN")
                dtDiemTH.Columns.Add("Xep_loai_TN")

                Dim x As Integer
                x = dtMonTN.Rows.Count - 1
                For i As Integer = 0 To dtDiemTH.Rows.Count - 1
                    dtDiemTH.Rows(i)("TBC_TN") = Math.Round(((dtDiemTH.Rows(i)(("M" & dtMonTN.Rows(0)("ID_mon").ToString)) * 1 + dtDiemTH.Rows(i)(("M" & dtMonTN.Rows(1)("ID_mon").ToString)) * 2 + dtDiemTH.Rows(i)("TBCHT") * 3) / 5), 1)
                Next
                For i As Integer = 0 To dtDiemTH.Rows.Count - 1
                    If dtDiemTH.Rows(i)("TBC_TN") <= 10 And dtDiemTH.Rows(i)("TBC_TN") >= 9 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "Xuất sắc"
                    ElseIf dtDiemTH.Rows(i)("TBC_TN") >= 8 And dtDiemTH.Rows(i)("TBC_TN") < 9 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "Giỏi"
                    ElseIf dtDiemTH.Rows(i)("TBC_TN") >= 7 And dtDiemTH.Rows(i)("TBC_TN") < 8 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "Khá"
                    ElseIf dtDiemTH.Rows(i)("TBC_TN") >= 6 And dtDiemTH.Rows(i)("TBC_TN") < 7 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "TB Khá"
                    ElseIf dtDiemTH.Rows(i)("TBC_TN") >= 5 And dtDiemTH.Rows(i)("TBC_TN") < 6 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "Trung bình"
                    ElseIf dtDiemTH.Rows(i)("TBC_TN") >= 4 And dtDiemTH.Rows(i)("TBC_TN") < 5 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "Yếu"
                    ElseIf dtDiemTH.Rows(i)("TBC_TN") >= 0 And dtDiemTH.Rows(i)("TBC_TN") < 4 Then
                        dtDiemTH.Rows(i)("Xep_loai_TN") = "Kém"
                    End If
                Next
            End If
            ...
            If dtDiemTH.Rows.Count > 0 Then
                Dim rpt As New rpt_TongHopToanKhoa_New(dtDiemTH, dtMonHoc, Tieu_de1, Tieu_de2, dtTenMon)

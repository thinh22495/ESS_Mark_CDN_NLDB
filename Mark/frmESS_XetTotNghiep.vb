        ...
        Try
            If cmbNam_hoc.Text.Trim <> "" And cmbLan_thu.Text.Trim <> "" Then
                ...
                If dtSV_dat.Rows.Count > 0 Then
                    ...
                    Tieu_de3 = InputBox("Nhập thời gian đào tạo :", "", "VD: 22/04/2015 - 22/04/2017")
                    If cmbLan_thu.Text = 1 Then
                        Tieu_de1 = "DANH SÁCH ĐƯỢC CÔNG NHẬN VÀ CẤP BẰNG TỐT NGHIỆP "
                    End If
                    ...
                    If dt.Rows.Count > 0 Then
                        Dim rpt As New rptDanhSach_Dat_TotNghiep(dt, dtMonHoc, Tieu_de1, Tieu_de2, Tieu_de3, True, No)
                        rpt.DataSource = dt
                        PrintXtraReport(rpt)
                    Else

...
#End Region
    ...
    Private Sub BarButtonItem1_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItem1.ItemClick
        Try
            ...
            Dim report As New rpt_DiemTongKetMonHoc_Mau05a(dv, Ten_mon)
    ...
    Private Sub btnInBangDiemTheoMon_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnInBangDiemTheoMon.ItemClick
        Try
            Dim dv As DataView = grdViewDiem.DataSource
            Dim dtTP As DataTable
            dtTP = clsDiem.DanhSachThanhPhanChon
            Dim report As New rpt_InDiemTongKetMonHoc_Mau05a(dtTP, dv, cmbID_mon.Text)
            Dim printTool As New ReportPrintTool(report)
            printTool.ShowPreviewDialog()

...
#Region "Function"
        Public Sub ChuyenThiTotNghiep_No(ByVal dv As DataView)
            For i As Integer = 0 To dv.Count - 1
                If dv.Item(i)("Chon3") = True Then
                    Delete_DanhSachNoTotNghiep(dv.Item(i)("ID_SV"))
                    Dim obj As New DanhSachLuanVanThiNoTotNghiep
                    obj.ID_sv = dv.Item(i)("ID_SV")
                    obj.TBCHT = IIf(IsDBNull(dv.Item(i)("TBCHT3")), 0, dv.Item(i)("TBCHT3"))
